...
export const validatePassword = (user: UserTypeMongo, password: string) => { // Devuelve true si colocamos una contraseña correcta en el logueo
...
export const waitFor = (time: number) => { // Hace que tu código asincrónico espere un tiempo (en milisegundos) que le pases como parámetro antes de continuar la ejecución
