...
const validateToken = (req: Request, res: Response, next: NextFunction) => {    
    if (req.path === "/" && (req.method === "GET" || req.method === "HEAD")) return next() // Si la petición es a la ruta principal, se permite el acceso siempre y cuando sea con el método GET o HEAD
